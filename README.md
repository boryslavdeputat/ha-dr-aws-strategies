...
High availability and disaster recovery strategies on AWS: RPO/RTO tables, multi-AZ vs multi-region, pilot light, warm standby, active-active.
...
- `docs/DR_DRILL.md`
- `templates/dr-runbook.md`
- `examples/rpo-rto-matrix.csv`
